...
specificity
```
Smanjenjem parametara logističke regresije često možemo poboljšati njezinu učinkovitost. Stoga sada treniramo novi model s parametrima koji su bili statistički značajni na razini većoj od 0,05.
