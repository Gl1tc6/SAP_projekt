...
U našem projektu obrađujemo veliki dataset kreditnog stanja korisnika neke banke. Naš je zadatak procjentiti koji čimbenici utječu na sposobnost otplate kredita u zadanome roku.
...
Ovdje imamo prikaz statistike za sve varijable kojima imamo pristup. Prva nam tablica pokazuje generalno o podatcima koje smo predstavili u CSV datoteci. Druga tablica daje overview <char> varijabli te njihove statistike. Treća tablica prikazuje statistiku numeričkih varijabli.
...
## 1.pitanje: Možemo li temeljem drugih dostupnih varijabli predvidjeti hoće li nastupiti _default_ za određenog klijenta? Koje varijable povećavaju tu vjerojatnost?
